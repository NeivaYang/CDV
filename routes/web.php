...
Route::get('/clientes/cdc/{id_cliente}', [ClienteController::class, 'gerenciarCdcCliente'])->name('cdc.cliente.gerenciar');

Route::get('/clientes/cdc/cadastrar/{id_cliente}', [ClienteController::class, 'cadastrarCdcCliente'])->name('cdc.cliente.cadastrar');
Route::post('/clientes/cdc/cadastra/submit', [ClienteController::class, 'salvarCdcCliente'])->name('cdc.cliente.salvar');                                                                                    
Route::get('/clientes/cdc/editar/{id}', [ClienteController::class, 'editarCdcCliente'])->name('cdc.cliente.editar');
Route::put('/clientes/cdc/atualiza', [ClienteController::class, 'atualizarCdcCliente'])->name('cdc.cliente.atualizar');
...
Route::get('/itensVenda', [ItensVendaController::class, 'listarItensVenda'])->name('itensVenda.gerenciar');
...
Route::get('/itensVenda/edita/{id}', [ItensVendaController::class, 'editaItensVenda'])->name('itensVenda.edita');
Route::put('/itensVenda/editar', [ItensVendaController::class, 'editarItensVenda'])->name('itensVenda.editar');
Route::get('/itensVenda/exclui/{id}', [ItensVendaController::class, 'modalExclusaoItemsVenda'])->name('itensVenda.exclui');
