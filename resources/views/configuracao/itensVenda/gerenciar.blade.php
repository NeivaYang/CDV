...
@section('conteudo')
    <tabela-lista-new
        ...
        criar="{{ route('itensVenda.cadastrar') }}"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="nome">@lang('produto.nome')<em class="label-required"> *</em>
                            <input type="text" class="form-control" id="nome" name="nome" maxlength="50" v-model="$store.state.item.nome"readonly/>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        <label for="unidade">@lang("comum.unidade")<em class="label-required"> *</em>
                            <input type="unidade" class="form-control" id="unidade" name="unidade" maxlength="50" v-model="$store.state.item.unidade" readonly/>
                        </label>
                    </div>    
                </div>
            </div>            
