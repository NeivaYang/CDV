...
@section('conteudo')
    <form action="{{route('cdc.cliente.salvar')}}" class='row' id="form_submit" method="post">
        {{csrf_field()}}
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="fazenda">@lang('cliente.fazenda')<em class="label-required"> *</em>
                        <input type="text" class="form-control" id="fazenda" name="fazenda" maxlength="100" required/>   
                    </label>
                </div>
            </div>
