    ...
    <form action="{{route('cliente.salvar')}}" class='row' id="form_submit" method="post">
        ...
        <div class="col-12">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    <label for="documento">@lang('cliente.documento')<em class="label-required"> *</em>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    <label for="area_total">@lang('cliente.area_total')
                        <input type="number" class="form-control pr-5" id="area_total" name="area_total" min="0" max="99999999" step="any" value="{{ old('area_total') }}"/>
                ...
                <div class="form-group col-md-3">
                    <label for="area_irrigada">@lang('cliente.area_irrigada')<em class="label-required"> *</em>
                        <input type="number" class="form-control pr-5" id="area_irrigada" name="area_irrigada" min="1" max="99999999" step="any" value="{{ old('area_irrigada') }}" required/>
                        <em class="input-unidade">ha</em>    
                    </label>
                </div>
                ...
                <div class="form-group col-md-3">
                    <label for="fazenda">@lang('cliente.fazenda')<em class="label-required"> *</em>
                        <input type="text" class="form-control" id="fazenda" name="fazenda" maxlength="100" value="{{ old('fazenda') }}" required/>   
                    </label>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    <label for="estado">@lang('cliente.uf_fazenda')<em class="label-required"> *</em>
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    <label for="pivo_central">@lang('cliente.pivoCentralQtd')
                        <input type="number" class="form-control" id="pivo_central" name="pivo_central_qtd" value="{{ old('pivo_central_qtd') }}"/>
                    </label>
                </div>

                <div class="form-group col-md-3">
                    <label for="linear">@lang('cliente.linearQtd')
                        <input type="number" class="form-control" id="linear" name="linear_qtd" value="{{ old('linear_qtd') }}"/>
                    </label>
                </div>

                <div class="form-group col-md-3">
                    <label for="autopropelido">@lang('cliente.autopropelidoQtd')
                        <input type="number" class="form-control" id="autopropelido" name="autopropelido_qtd" value="{{ old('autopropelido_qtd') }}"/>
                    </label>
                </div>
            </div>
