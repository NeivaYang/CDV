            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="id_servico">@lang('oportunidade.servico')<em class="label-required"> *</em>
                        <select name="id_servico[]" id="" class='form-control selectpicker' multiple title="@lang('comum.seleciona_item')" required>                            
                ...
                <div class='form-group col-md-4' >
                    <label for="data_proposta">@lang('proposta.data_proposta')<em class="label-required"> *</em>
                        <input name='data_proposta' value="{{$proposta['data_proposta']}}" class='form-control' required='true' type='date' id='data_proposta' required />                    
                    </label>
                </div>        
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    <label for="quantidade_equipamento">@lang('proposta.quantidade_equipamento')<em class="label-required"> *</em>
                        <input class="form-control" id="quantidade_equipamento" name="quantidade_equipamento" type="number" aria-describedby="" min="1" max="99999" value="{{$proposta['quantidade_equipamento']}}" required/>
                    </label>
                </div>
               
                <div class="form-group col-md-3">
                    <label for="area_abrangida">@lang('proposta.area_abrangida')<em class="label-required"> *</em>
                        <input class="form-control pr-5" id="area_abrangida" name="area_abrangida" type="number" aria-describedby="" min="1" max="99999999" value="{{$proposta['area_abrangida']}}" required/>
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    <label for="valor_area">@lang('proposta.valor_area')<em class="label-required"> *</em>
                        <input class="form-control maskMoney" id="valor_area" name="valor_area" type="text" aria-describedby="" min="1" max="999999999" value="{{$proposta['valor_area']}}" required/>
                    </label>
                </div>
                ...
                <div class="form-group col-md-3">
                    <label for="desconto_concedido">@lang('proposta.desconto_concedido')
                        <input class="form-control pr-5 maskMoney" id="desconto_concedido" name="desconto_concedido" type="text" aria-describedby="" min="0" max="100" value="{{$proposta['desconto_concedido']}}" />
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="descricao">@lang('proposta.descricao')
                        <textarea name="descricao" class="form-control" id="descricao" rows="3" cols="100">{{$proposta['descricao']}}</textarea>                    
                    </label>
                </div>        
            </div>
