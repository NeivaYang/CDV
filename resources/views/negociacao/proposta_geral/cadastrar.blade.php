                ...
                <table class="table table-striped" id="tabela_itens">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><input name='quantidade_equipamento[]' class="form-control" type="number" min="1" max="99999" aria-describedby="" /></td>
                        <td><input name='unidade[]' class="form-control" style="text-align: center; vertical-align: middle;" value="" readonly/></td>
                        ...
                        <td><input name='valor_unitario[]' class="form-control maskMoney" type="text" onchange="calculaValores(this)" value="0" required /></td>
                        <td><input name='valor_total[]' class="form-control" style="text-align: center; vertical-align: middle;" value="0,00" readonly/></td>
                        <td><input name='desconto_concedido[]' id="desconto_concedido" class="form-control maskMoney" type="text" onchange="calculaValores(this)" value="0" /></td>
                        <td><input name='valor_final[]' class="form-control" style="text-align: center; vertical-align: middle;" value="0,00" readonly/></td>
