                                    ...
                                    <div class="col-12">
                                        <table class="table" id="tabela_itens_gerenciar">
                                            <thead style="background-color: transparent !important;">
                                                ...
                                                <th scope="col" style="width: 13%">@lang('proposta.sistema_irrigacao')</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$proposta_itens['quantidade_equipamento']}}</td>
                                                    <td>{{$proposta_itens['unidade']}}</td>
                                                    <td>{{$proposta_itens['quantidade']}}</td>
                                                    <td>{{$proposta_itens['valor_unitario']}}</td>
                                                    <td>{{$proposta_itens['valor_total']}}</td>
                                                    <td>{{$proposta_itens['desconto_concedido']}}</td>
                                                    <td>{{$proposta_itens['valor_final']}}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
