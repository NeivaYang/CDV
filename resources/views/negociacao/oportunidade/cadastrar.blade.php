...
@section('conteudo')
    <form action="{{route('oportunidade.salvar')}}" class='row' id="form_submit" method="post">
        ...
        <div class="col-12">
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    <label for="tipo">@lang('oportunidade.tipo')<em class="label-required"> *</em>
                        <select name="tipo" id="tipo" class='form-control' required>
                            <option value="">@lang('comum.seleciona_item')</option>
                            <option value="produto">@lang('oportunidade.produto')</option>
                            <option value="servico">@lang('oportunidade.servico')</option>
                        </select>                        
                    </label>
                </div>
