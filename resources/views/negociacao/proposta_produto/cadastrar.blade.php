...
@section('conteudo')
    <form action="{{route('proposta.produto.salvar')}}" class='row' id="form_submit" method="post">
        ...
        <div class="col-12">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <label for="data_proposta">@lang('proposta.area_manejada')
                        <input name='area_manejada' value="" class='form-control' type='number' id='area_manejada' required />                    
                    </label>
                </div>    
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="quanitdade_equipamento">@lang('proposta.quantidade_equipamento')
                        <input class="form-control" id="quantidade_equipamento" name="quantidade_equipamento" type="number" aria-describedby="" min="1" max="99999" />
                    </label>
                </div>
               
                <div class="form-group col-md-4">
                    <label for="area_abrangida">@lang('proposta.area_abrangida')
                        <input class="form-control" id="area_abrangida" name="area_abrangida" type="number" aria-describedby="" min="1" max="99999999" />
                    </label>
                </div>

                <div class="form-group col-md-4">
                    <label for="quantidade_lance">@lang('proposta.quantidade_lance')
                        <input class="form-control" id="quantidade_lance" name="quantidade_lance" type="number" aria-describedby="" min="1" max="99999" />
                    </label>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="valor_total">@lang('proposta.valor_proposta') 
                        <input class="form-control" id="valor_total" name="valor_total" type="number" aria-describedby="" min="0" max="99999" />
                    </label>
                </div>

                <div class="form-group col-md-4">
                    <label for="desconto_concedido">@lang('proposta.desconto_concedido')
                        <input class="form-control" id="desconto_concedido" name="desconto_concedido" type="number" aria-describedby="" min="0" max="100" />
                    </label>
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    <input class="form-control" id="expectativa_sucesso" name="expectativa_sucesso" type="number" aria-describedby="" value="{{$negociacao['expectativa_sucesso']}}" min="{{$negociacao['expectativa_sucesso']}}" max="100" step="5" />
        ...
        <div class="col-12 text-left">
            ...
            <a class="btn btn-outline-dark" href="{{route('proposta.gerenciar', $negociacao['id_negociacao'])}}">@lang('buttons.voltar')</a>
        </div>
    </form>
@endsection
