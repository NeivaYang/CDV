...
class CreateOportunidadesEncerradasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('oportunidades_encerradas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('oportunidades_encerradas');
    }
}
